...
export default function Home() {
  ...
  <section id="menu" className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          {/* VALENTÍNSKA AKCIA - BURGER DAY */}
          <div className="mb-20">
            <div className="py-12 px-4 bg-gradient-to-br from-rose-950 via-pink-900 to-red-950 relative overflow-hidden rounded-3xl">
              <div className="absolute inset-0 bg-gradient-radial from-pink-500/20 via-transparent to-transparent animate-pulse"></div>
              <div className="absolute top-10 left-10 text-6xl animate-bounce opacity-30">💕</div>
              <div className="absolute top-20 right-16 text-4xl animate-pulse opacity-40">❤️</div>
              <div className="absolute bottom-16 left-20 text-5xl animate-bounce opacity-30" style={{animationDelay: '0.5s'}}>💖</div>
              <div className="absolute bottom-10 right-10 text-6xl animate-pulse opacity-40" style={{animationDelay: '0.3s'}}>💝</div>
              
              <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-8">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-rose-500 to-pink-600 rounded-full mb-4 animate-bounce-slow">
                    <span className="text-white font-black text-sm md:text-base uppercase tracking-wider">💕 VALENTÍNSKA AKCIA 💕</span>
                  </div>
                  <h3 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-pink-500 to-red-400 mb-4 drop-shadow-2xl">
                    MUNCH LOVE BOX
                  </h3>
                  <p className="text-2xl md:text-4xl text-white font-black mb-2">
                    BOX PRE DVOCH - 24,90 € 💕
                  </p>
                  <p className="text-rose-300/80 text-lg mt-2">💘 Sobota 14. februára - Valentín nemusíš tráviť v reštaurácii! 💘</p>
                </div>

                <div className="flex justify-center">
                  <div className="w-full max-w-3xl bg-gradient-to-br from-rose-900/60 to-pink-900/60 backdrop-blur-xl rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(244,63,94,0.4)] hover:shadow-[0_0_80px_rgba(244,63,94,0.6)] transition-all duration-500 hover:scale-[1.02] relative">
                    <div className="relative h-[28rem] md:h-[36rem] w-full overflow-hidden bg-gradient-to-b from-rose-900/40 to-pink-900/40">
                      <div className="absolute top-0 left-0 w-16 md:w-24 h-16 md:h-24 border-t-4 border-l-4 border-rose-400 rounded-tl-3xl pointer-events-none z-10" />
                      <div className="absolute top-0 right-0 w-16 md:w-24 h-16 md:h-24 border-t-4 border-r-4 border-rose-400 rounded-tr-3xl pointer-events-none z-10" />
                      <div className="absolute bottom-0 left-0 w-16 md:w-24 h-16 md:h-24 border-b-4 border-l-4 border-rose-400 rounded-bl-3xl pointer-events-none z-10" />
                      <div className="absolute bottom-0 right-0 w-16 md:w-24 h-16 md:h-24 border-b-4 border-r-4 border-rose-400 rounded-br-3xl pointer-events-none z-10" />
                      
                      <Image
                        src="/images/valentin.jpg"
                        alt="Munch Love Box - Valentínske menu pre dvoch"
                        fill
                    ...
                    <div className="p-6 md:p-8">
                      <div className="bg-rose-950/60 backdrop-blur-sm rounded-2xl p-4 md:p-6 border border-rose-400/30 mb-6">
                        <h5 className="text-rose-300 text-lg font-bold mb-3 flex items-center justify-center gap-2">
                          🍔 Obsah boxu
                        </h5>
                        <div className="text-rose-100 text-sm md:text-base space-y-3">
                          <div className="text-center">
                            <p className="font-bold text-white text-lg">Crispy Chicken Burger</p>
                            <p className="text-rose-200 text-xs md:text-sm">Vyprážané kuracie prsia, cheddar, citrónová majonéza, ľadový šalát, paradajka</p>
                          </div>
                          <div className="text-center">
                            <p className="font-bold text-white text-lg">Smash Bacon Burger</p>
                            <p className="text-rose-200 text-xs md:text-sm">2× smash hovädzia placka, double cheddar, slanina, pepper mayo, karamelizovaná cibuľa, chrumkavá cibulka</p>
                          </div>
                          <div className="text-center pt-2 border-t border-rose-400/20">
                            <p className="font-bold text-white">🍟 Hranolky + 🥗 Coleslaw + 🥫 Omáčky</p>
                          </div>
                        </div>
                      </div>
                      <div className="text-center">
                        <a
                          href={`tel:${PHONE_TEL}`}
                          className="inline-block px-10 py-4 bg-gradient-to-r from-rose-500 via-pink-600 to-red-500 text-white text-xl font-black rounded-full hover:scale-110 transition-transform duration-300 shadow-2xl uppercase tracking-wide"
                        >
                          💕 Objednaj Love Box! 💕
                        </a>
                        <p className="text-rose-300/80 text-base mt-3 font-semibold">📍 Munch Bro&apos;s Senec</p>
                        <p className="text-rose-300/70 text-sm mt-1">Príď • Objednaj • Zdieľaj 💕</p>
                        <p className="text-rose-300/60 text-sm mt-1">📞 0949 593 999</p>
                      </div>
                    </div>
                  </div>
                </div>
